...
RUN comfy model download --url https://huggingface.co/Comfy-Org/ltx-2/blob/main/split_files/text_encoders/gemma_3_12B_it_fp4_mixed.safetensors --relative-path models/clip --filename gemma_3_12B_it_fp4_mixed.safetensors
RUN comfy model download --url https://huggingface.co/Lightricks/LTX-2/resolve/main/ltx-2-19b-distilled-fp8.safetensors --relative-path models/checkpoints --filename ltx-2-19b-distilled-fp8.safetensors
...
RUN comfy model download --url https://huggingface.co/Lightricks/LTX-2-19b-IC-LoRA-Detailer/blob/main/ltx-2-19b-ic-lora-detailer.safetensors --relative-path models/loras --filename ltx-2-19b-ic-lora-detailer.safetensors
